...
#ifndef VELOX_SWIFT_H
#define VELOX_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Velox",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC5Velox11AppDelegate")
...
SWIFT_CLASS("_TtC5Velox15CommandBarPanel")
@interface CommandBarPanel : NSPanel
